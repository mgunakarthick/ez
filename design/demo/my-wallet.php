...
<section class="container">
	<div class="row">
		<div class="col-12">			
			<h1>My Wallet</h1>			
			<div class="mywallet"><small>Balance on Your Waller:</small><span>Rs 0.00</span></div>	
			<div class="money">	
				<h3>Add Money to Wallet</h3>		  		
			  	<div class="row" id="offer">
			  		...
			  		<div class="col-12 col-sm-4 btnsub">		  			
			  			<form action="wallet-success.php"><input type="submit" value="Add Money to Wallet" /></form>
			  		</div>
			  	</div>
