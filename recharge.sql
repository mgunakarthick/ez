...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2018 at 07:22 AM
...
(1, 'Default', '', 1, '2018-03-03 12:13:21', '2018-03-03 12:13:21');
...
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2018-03-03 07:03:32'),
...
CREATE TABLE `customer` (
  ...
  `date_added` datetime NOT NULL,
  `wallet` float(5,2) NOT NULL DEFAULT '0.00',
  `username` varchar(100) NOT NULL,
  `apipwd` varchar(100) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `customer` (`customer_id`, `customer_group_id`, `store_id`, `language_id`, `firstname`, `lastname`, `email`, `telephone`, `fax`, `password`, `salt`, `cart`, `wishlist`, `newsletter`, `address_id`, `custom_field`, `ip`, `status`, `safe`, `token`, `code`, `date_added`, `wallet`, `username`, `apipwd`) VALUES
(1, 1, 0, 1, 'guna', 'seelan', 'guna2me@gmail.com', '1234234234', '', '93426e6cb2ef52de6e945448feec4496a6399af5', 'Una2DC0Za', NULL, NULL, 0, 0, '[]', '::1', 1, 0, '', '', '2018-03-07 00:39:26', 0.00, '', ''),
(2, 1, 0, 1, 'TEST DISTRIBUTOR', 'test', 'csf@dasf.com', '1234234234', '', '098f6bcd4621d373cade4e832627b4f6', 'Una2DC0Za', NULL, NULL, 0, 0, '[]', '::1', 1, 0, '', '', '2018-03-07 00:39:26', 0.00, '200002', 'paumbzdy');
...
(1, 'admin@sdfsdf.sds', '::1', 1, '2018-03-04 17:39:23', '2018-03-04 17:39:23');
...
('::1', 0, 'http://localhost/r/index.php?route=recharge/mobile', 'http://localhost/r/', '2018-03-09 05:21:23');
...
(4, 1, 'About Us', '&lt;p&gt;&lt;b&gt;\r\n	http://www.eazy-pay.com About Us will be updated soon&lt;/b&gt;&lt;/p&gt;\r\n', 'eazy-pay.com About Us', 'eazy-pay.com About Us', 'eazy-pay.com About Us');
...
(846, 0, 1, 'information_id=4', 'about_us'),
...
('501f431f6128d868d9cff57cf1', 'false', '2018-03-08 16:16:06'),
('71dbc459f4ba284a4b8fdaa004', '{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"NM5KxyqzKz8fINTINPlYg35pbF2EXbgN\"}', '2018-03-09 05:45:23'),
('972cd25c983cff64a9cece8ecd', '{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"CSg0mLmxTRdkLEX72pGNqyyE3Gs4rf7T\"}', '2018-03-07 20:25:06'),
('acde97f6a5868af3c7d1debb29', '{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"KcOJjl10v72nXSNqq7HhUra8UHgAkv4J\"}', '2018-03-04 12:15:32');
...
(457, 0, 'config', 'config_seo_url', '1', 0),
(458, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai\'hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
(465, 0, 'config', 'config_file_ext_allowed', 'zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc', 0),
(466, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf', 0),
(467, 0, 'config', 'config_error_display', '1', 0),
(468, 0, 'config', 'config_error_log', '1', 0),
(469, 0, 'config', 'config_error_filename', 'error.log', 0),
(4, 0, 'voucher', 'total_voucher_sort_order', '8', 0),
(5, 0, 'voucher', 'total_voucher_status', '1', 0),
(464, 0, 'config', 'config_file_max_size', '300000', 0),
(459, 0, 'config', 'config_compression', '0', 0),
(460, 0, 'config', 'config_secure', '0', 0),
(461, 0, 'config', 'config_password', '1', 0),
(462, 0, 'config', 'config_shared', '0', 0),
(463, 0, 'config', 'config_encryption', '', 0),
(456, 0, 'config', 'config_maintenance', '0', 0),
(455, 0, 'config', 'config_mail_alert_email', '', 0),
(450, 0, 'config', 'config_mail_smtp_username', '', 0),
(454, 0, 'config', 'config_mail_alert', '[\"order\"]', 1),
(453, 0, 'config', 'config_mail_smtp_timeout', '5', 0),
(452, 0, 'config', 'config_mail_smtp_port', '25', 0),
(451, 0, 'config', 'config_mail_smtp_password', '', 0),
(449, 0, 'config', 'config_mail_smtp_hostname', '', 0),
(448, 0, 'config', 'config_mail_parameter', '', 0),
(446, 0, 'config', 'config_icon', 'catalog/eazy-pay/logo.png', 0),
(447, 0, 'config', 'config_mail_engine', 'mail', 0),
(445, 0, 'config', 'config_logo', 'catalog/eazy-pay/logo.png', 0),
(444, 0, 'config', 'config_captcha_page', '[\"review\",\"return\",\"contact\"]', 1),
(443, 0, 'config', 'config_captcha', '', 0),
(441, 0, 'config', 'config_return_id', '0', 0),
(442, 0, 'config', 'config_return_status_id', '2', 0),
(440, 0, 'config', 'config_affiliate_id', '4', 0),
(438, 0, 'config', 'config_affiliate_auto', '0', 0),
(439, 0, 'config', 'config_affiliate_commission', '5', 0),
(436, 0, 'config', 'config_affiliate_group_id', '1', 0),
(437, 0, 'config', 'config_affiliate_approval', '0', 0),
(435, 0, 'config', 'config_stock_checkout', '0', 0),
(434, 0, 'config', 'config_stock_warning', '0', 0),
(433, 0, 'config', 'config_stock_display', '0', 0),
(432, 0, 'config', 'config_api_id', '1', 0),
(431, 0, 'config', 'config_fraud_status_id', '7', 0),
(430, 0, 'config', 'config_complete_status', '[\"5\",\"3\"]', 1),
(428, 0, 'config', 'config_order_status_id', '1', 0),
(429, 0, 'config', 'config_processing_status', '[\"5\",\"1\",\"2\",\"12\",\"3\"]', 1),
...
(470, 0, 'developer', 'developer_theme', '0', 0),
(427, 0, 'config', 'config_checkout_id', '5', 0),
(426, 0, 'config', 'config_checkout_guest', '0', 0),
(425, 0, 'config', 'config_cart_weight', '0', 0),
(424, 0, 'config', 'config_invoice_prefix', 'INV-2018-00', 0),
(423, 0, 'config', 'config_account_id', '3', 0),
(422, 0, 'config', 'config_login_attempts', '15', 0),
(421, 0, 'config', 'config_customer_price', '0', 0),
(420, 0, 'config', 'config_customer_group_display', '[\"1\"]', 1),
(419, 0, 'config', 'config_customer_group_id', '1', 0),
(418, 0, 'config', 'config_customer_search', '1', 0),
(417, 0, 'config', 'config_customer_activity', '1', 0),
(416, 0, 'config', 'config_customer_online', '1', 0),
(415, 0, 'config', 'config_tax_customer', '', 0),
(414, 0, 'config', 'config_tax_default', '', 0),
(413, 0, 'config', 'config_tax', '0', 0),
(412, 0, 'config', 'config_voucher_max', '1000', 0),
(411, 0, 'config', 'config_voucher_min', '1', 0),
(410, 0, 'config', 'config_review_guest', '0', 0),
(409, 0, 'config', 'config_review_status', '0', 0),
(408, 0, 'config', 'config_limit_admin', '10', 0),
(407, 0, 'config', 'config_product_count', '0', 0),
(406, 0, 'config', 'config_weight_class_id', '1', 0),
(405, 0, 'config', 'config_length_class_id', '1', 0),
(404, 0, 'config', 'config_currency_auto', '0', 0),
(403, 0, 'config', 'config_currency', 'USD', 0),
(402, 0, 'config', 'config_admin_language', 'en-gb', 0),
(401, 0, 'config', 'config_language', 'en-gb', 0),
(400, 0, 'config', 'config_zone_id', '1503', 0),
(399, 0, 'config', 'config_country_id', '99', 0),
(398, 0, 'config', 'config_comment', '', 0),
(397, 0, 'config', 'config_open', '', 0),
(396, 0, 'config', 'config_image', 'catalog/eazy-pay/logo.png', 0),
(395, 0, 'config', 'config_fax', '', 0),
(394, 0, 'config', 'config_telephone', '123456789', 0),
(393, 0, 'config', 'config_email', 'guna2me@gmail.com', 0),
(392, 0, 'config', 'config_geocode', '', 0),
(391, 0, 'config', 'config_address', 'eazy-pay.com', 0),
(390, 0, 'config', 'config_owner', 'eazy-pay.com', 0),
(389, 0, 'config', 'config_name', 'eazy-pay.com', 0),
(388, 0, 'config', 'config_layout_id', '4', 0),
(387, 0, 'config', 'config_theme', 'default', 0),
(386, 0, 'config', 'config_meta_keyword', 'eazy-pay.com', 0),
(385, 0, 'config', 'config_meta_description', 'eazy-pay.com', 0),
(384, 0, 'config', 'config_meta_title', 'eazy-pay.com', 0),
(471, 0, 'developer', 'developer_sass', '1', 0);
...
(1, 1, 'admin', '7878fb3163265b169e6b67791be8fb7d6a5f2136', 'AFzxqogDM', 'John', 'Doe', 'guna2me@gmail.com', '', '', '::1', 1, '2018-03-03 12:13:21');
...
--
ALTER TABLE `setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=472;
