<?php
class ControllerExtensionDashboardBalance extends Controller {
	private $error = array();

	public function index() {
		//$this->load->language('extension/dashboard/balance');
	...
	public function dashboard() {
		...
		$this->load->model('catalog/eapi');
		$url = 'http://response.rcpanel.com/api_users/balance?username='._RC_PANAL_USER_.'&pwd='._RC_PANAL_PWD_;
		$data['balance'] = $this->model_catalog_eapi->sendCurl($url);
		return $this->load->view('extension/dashboard/balance', $data);
	}
}
